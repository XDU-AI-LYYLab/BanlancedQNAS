...
def get_common_config(parser):
    ...
    parser.add_argument(
        ...
        default="Qonshot1",#"ori_T800-evo-cifar100-k3k5-ECA",
        required=False)
    parser.add_argument("--resume", type=str, default=None,#"./logs/ori_T800-evo-cifar100-k3k5-ECA_42/checkpoints/search/search_750.pth",
                        #"./logs/T500-evo-cifar100-k3k5-ECA_44/checkpoints/search/best_model.pth",
                        #"./logs/T1000-evo-cifar100_44/checkpoints/search/best_model.pth",
                        help="Resume path")
    parser.add_argument(
        "--random-seed",
        type=int,
    ...
    parser.add_argument("--train-portion", type=float, default=0.80)
