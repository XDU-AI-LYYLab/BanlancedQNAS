...
from .evolution_search import balance_evolution_algorithm
...
class SearchStrategy:
    ...
    def search(self, trainer, training_strategy):
        ...
        supernet.module.set_activate_architecture(best_architecture) if isinstance(
            supernet, nn.DataParallel) else supernet.set_activate_architecture(best_architecture)
        best_architecture_top1 = trainer.validate(
            supernet, self.val_loader, 0)
